...
contract PropertyRegistryTest is Test {
    ...
    bytes32 public constant PROPERTY_CODE1 =
        keccak256(abi.encodePacked("GRD-LAG-0045"));
    bytes32 public constant PROPERTY_CODE2 =
        keccak256(abi.encodePacked("GRD-LAG-0046"));
    bytes32 public constant PROPERTY_CODE3 =
        keccak256(abi.encodePacked("GRD-NYC-0001"));
    bytes32 public constant NONEXISTENT_CODE =
    ...
    function _getProperty(
        bytes32 code
    ) internal view returns (PropertyRegistry.Property memory) {
        (
            uint8 flatCount,
        ...
        return
            PropertyRegistry.Property(flatCount, location, isActive, createdAt);
    }
    ...
    function test_RegisterProperty() public {
        ...
        emit PropertyRegistry.PropertyRegistered(
            operator,
            landlord1,
            PROPERTY_CODE1,
            10
        ...
        assertEq(
            propertyRegistry.propertyToLandlord(PROPERTY_CODE1),
            landlord1
        );
    ...
    function test_RegisterProperty_MultiplePropertiesForSameLandlord() public {
        ...
        bytes32[] memory codes = propertyRegistry.getPropertyCodesByLandlord(
            landlord1
        );
    ...
    function test_RegisterProperty_RevertsIfLandlordIsZeroAddress() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                PropertyRegistry.ZeroAddress.selector,
                address(0)
            )
        );
        propertyRegistry.registerProperty(
    ...
    function test_RegisterProperty_RevertsIfCodeExists() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                PropertyRegistry.DuplicatePropertyCode.selector,
                operator,
                PROPERTY_CODE1
            )
        );
    ...
    function test_UpdateProperty_BothFields() public {
        ...
        vm.expectEmit(false, false, false, true);
        emit PropertyRegistry.PropertyLocationUpdated(
            PROPERTY_CODE1,
            "Ikoyi",
            "Victoria Island"
        );
    ...
    function test_UpdateProperty_RevertsIfPropertyNotFound() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                PropertyRegistry.PropertyNotFound.selector,
                NONEXISTENT_CODE
            )
        );
    ...
    function test_UpdateProperty_RevertsIfPropertyInactive() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                PropertyRegistry.PropertyInactive.selector,
                PROPERTY_CODE1
            )
        );
    ...
    function test_GetProperty_AsLandlord() public {
        ...
        vm.prank(landlord1);
        PropertyRegistry.Property memory prop = propertyRegistry.getProperty(
            PROPERTY_CODE1
        );
        assertEq(prop.flatCount, 10);
        assertEq(prop.location, "Ikoyi");
    ...
    function test_GetProperty_RevertsIfUnauthorized() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                PropertyRegistry.UnauthorizedAccess.selector,
                randomUser
            )
        );
    ...
    function test_DeactivateProperty() public {
        ...
        emit PropertyRegistry.PropertyDeactivated(
            admin,
            PROPERTY_CODE1,
            landlord1
        );
    ...
    function test_GetPropertiesByLandlord() public {
        ...
        PropertyRegistry.Property[] memory props = propertyRegistry
            .getPropertiesByLandlord(landlord1);
        ...
        PropertyRegistry.Property[] memory props2 = propertyRegistry
            .getPropertiesByLandlord(landlord2);
    ...
    function test_GetPropertiesByLandlord_Empty() public view {
        PropertyRegistry.Property[] memory props = propertyRegistry
            .getPropertiesByLandlord(randomUser);
    ...
    function test_DeployerHasAdminAndOperatorRoles() public view {
        assertTrue(
            propertyRegistry.hasRole(
                propertyRegistry.DEFAULT_ADMIN_ROLE(),
                deployer
            )
        );
        assertTrue(
            propertyRegistry.hasRole(propertyRegistry.OPERATOR_ROLE(), deployer)
        );
    }
